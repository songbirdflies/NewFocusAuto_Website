    ...
    for each FormName in Upload.file '列出所有上传了的文件
      ...
      if file.FileSize>0 then '如果 FileSize > 0 说明有文件数据
        ...
        if Result="ok" then
          ...
          response.write "</tr>"		  
          response.write "<tr>"
          response.write "<td height='36' colspan='2' valign='bottom' align='center'><input name='CopyPath' type='button' class='button' value='拷贝文件路径'  onclick=""CopyPath('"&replace(right(FileName,len(FileName)),"../Upload","Upload")&"','"&GainFileSize(file.Filesize)&"')""></td>"
          response.write "</tr>"
...
Private Function CheckFileExt (FileEXT)
  dim ForumUpload
  ForumUpload="gif,jpg,jpeg,png,rar,zip,doc,pdf,exe,flv,swf"
