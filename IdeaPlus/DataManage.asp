...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <th>数据库操作：系统数据备分，压缩，恢复，管理员登录日志</th>
  </tr>
  <tr>
...
<%
function DataMain
  response.write ("<table cellpadding='0' cellspacing='0' bgcolor='#6298E1'><tr><td height='24' nowrap  bgcolor='#EBF2F9'>")
...
function DataBackup()
  ...
  response.write ("<table  border='0' cellpadding='0' cellspacing='0'><tr><td height='24' align='center'>")
  response.write ("<table class='noborder' cellspacing='0' cellpadding='0'><tr><td height='16'></td></tr>")
...
function DataCompact()
  ...
  From=request.QueryString("From")
  Result=request.QueryString("Result")
  response.write ("<table cellpadding='0' cellspacing='0'><tr><td height='24' align='center'>")
  response.write ("<table class='noborder' cellspacing='0' cellpadding='0'><tr><td height='16'></td></tr>")
...
function DataResume()
  ...
  Result=request.QueryString("Result")
  response.write ("<table cellpadding='0' cellspacing='0'><tr><td height='24' align='center'>")
  response.write ("<table class='noborder' border='0' cellspacing='0' cellpadding='0'><tr><td height='16'></td></tr>")
...
<table cellpadding="0" cellspacing="0">
    <tr>
      ...
      <th width="60">登录名</th>
      <th width="70">用户名</th>
      <th width="124">登录IP</th>
      <th width="260">登录时浏览器</th>
      <th width="104">创建时间</th>
      <th>操作
...
'-----------------------------------------------------------
  Response.Write "<tr>" & vbCrLf
  Response.Write "<td colspan='7' style='border-top:0px;'>" & vbCrLf
