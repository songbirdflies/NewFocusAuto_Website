...
*/
(function($){
    dk_slideplayer3 = function(object,config){
        this.obj = object;
        this.n =0;
        this.j =0;
        var _this = this;
        var t;
        var defaults = {width:"0px",height:"0px",fontsize:"12px",right:"0px",bottom:"5px",time:"5000"};
        ...
        this.resetclass =function(obj,i){
            ...
            $(obj).eq(i).css({color:"#ffffff",background:"#33d6fd",textDecoration:"none"});//修改数字框背景颜色
        }
        this.factory();
    }
})(jQuery)
