...
function AddSort(SortNameLangI,ID,Path,SortName1)
{
	//alert(SortName1);
	window.opener.editForm.SortNameLangI.focus();								
	window.opener.document.editForm.SortNameLangI.value=SortName1;
